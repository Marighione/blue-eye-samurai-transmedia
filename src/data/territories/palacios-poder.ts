...
export const palaciosPoderId: Territory = {
  id: 'palacios-poder',
  ...
  shortStory: 'Dicen que una princesa aprendió a leer no porque su padre se lo permitiera, sino porque nadie pensó en prohibírselo. Nadie imaginó que querría. Eso es lo que el poder hace con las mujeres: no las encadena. Las ignora. Y en ese olvido, algunas encuentran su única libertad.',
  relatedCharacters: ['akemi'],
  relatedDocumentIds: ['doc-05', 'doc-08'],
  rvExperienceId: 'rv-honor',
