    ...
    <div className="min-h-screen bg-night">
      ...
      <div className="pt-32 pb-16 px-8 md:px-20">
        <motion.div variants={staggerContainer} initial="hidden" animate="visible">
          ...
          <motion.p variants={revealFromFog} className="font-narrative italic text-snow/70 text-lg max-w-xl leading-relaxed">
      ...
      {/* Experiencias */}
      <div className="px-8 md:px-20 py-16 space-y-2">
        {EXPERIENCES.map((exp, i) => {
          ...
          return (
            ...
            >
              <Link
                href={exp.href}
                className="group block border border-white/5 hover:border-gold/20 bg-deep-blue/20 hover:bg-deep-blue/40 transition-all duration-500 p-8 md:p-12"
              >
                <div className="flex items-start justify-between gap-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-4">
                      <p
                        className="font-ui text-xs font-semibold uppercase tracking-widest"
                    ...
                    <p className="font-narrative text-base text-snow/70 leading-relaxed max-w-xl mb-6">
                      {exp.description}
                    </p>
                    <p className="font-ui text-xs text-mist/70 uppercase tracking-widest">{exp.detail}</p>
                  </div>
